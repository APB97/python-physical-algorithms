...
def search_bukin_n6(max_gens, search_space, pop_size, num_accepted, print_progress=False):
...
if __name__ == "__main__":
    ...
    # execution
    best_found = search_bukin_n6(generations, problem_bounds, population_size, number_accepted, print_progress=True)
