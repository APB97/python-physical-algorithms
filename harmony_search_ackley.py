...
def search_ackley(bounds, max_iter, mem_size, consider_rate, adjust_rate, harm_range, print_progress=False):
...
if __name__ == "__main__":
    ...
    iters = 500
    # execution
    best_found = search_ackley(problem_bounds, iters, mem, consider, adjust, harmony_range, print_progress=True)
